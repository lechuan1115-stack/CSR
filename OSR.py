...
parser.add_argument('--method', choices=['threshold','softmax','openmax'], default='threshold',
...
def main():
    ...
    indatapath = f'E:/项目所用代码/RFF-OSR/data/ADS-B_{snr}dB_test.mat'
    outdatapath = f'E:/项目所用代码/RFF-OSR/data/ADS-B_IQ_{unknown}test_{snr}dB.mat'
    ptpath = f'E:/项目所用代码/RFF-OSR/data/Memory_fixdata_20/P4AllCNN{snr}dB.pt'
